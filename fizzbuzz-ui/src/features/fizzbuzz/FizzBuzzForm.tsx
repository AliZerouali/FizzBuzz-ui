    ...
    <div className="fizzbuzz-form">
      <form onSubmit={handleSubmit}>
        ...
        <button
          ...
          disabled={loading}
          className={
            "bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-semibold py-2 px-4 rounded-lg shadow-lg " +
            "focus:outline-none focus:ring-2 focus:ring-blue-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          }
        >
